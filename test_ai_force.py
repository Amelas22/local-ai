#!/usr/bin/env python3
"""
Force AI-based boundary detection only
"""
...
# Temporarily disable the advanced detector to force AI approach
detector.boundary_detector = None

# Process the test PDF
pdf_path = "/tmp/tesdoc_Redacted.pdf"

print("Testing AI-based boundary detection (forced) on:", pdf_path)
print("=" * 80)
