...
class FMCSRLoader:
    ...
    def _define_part_descriptions(self) -> Dict[str, Dict[str, str]]:
        ...
        return {
            ...
            "392": {
                ...
                "topics": ["driving", "operation", "safety_rules", "prohibited_practices"]
            },
            "393": {
    ...
    def _extract_regulation_topics(self, text: str) -> List[str]:
        ...
        topic_keywords = {
            'hours_of_service': ['hours of service', '11-hour', '14-hour', '70-hour', '60-hour', 'rest period'],
            'driver_qualification': ['qualified', 'disqualified', 'medical certificate', 'physical examination'],
            'vehicle_inspection': ['inspection', 'pre-trip', 'post-trip', 'annual inspection'],
            'drug_testing': ['drug test', 'alcohol test', 'controlled substance', 'random testing'],
