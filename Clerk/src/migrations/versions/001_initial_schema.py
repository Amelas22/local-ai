...
def upgrade() -> None:
    ...
    op.create_table('cases',
        ...
        sa.Column('law_firm_id', sa.String(length=36), nullable=False),
        sa.Column('status', sa.Enum('active', 'archived', 'closed', 'deleted', name='casestatus'), nullable=False, server_default='active'),
    ...
    op.create_index('idx_cases_collection_name', 'cases', ['collection_name'], unique=False)
    ...
    op.create_table('user_case_permissions',
        sa.Column('id', sa.String(length=36), nullable=False),
    ...
    op.create_index('idx_user_case_permissions_case_id', 'user_case_permissions', ['case_id'], unique=False)
    op.create_index('idx_user_case_permissions_user_case', 'user_case_permissions', ['user_id', 'case_id'], unique=True)
    op.create_index('idx_user_case_permissions_user_id', 'user_case_permissions', ['user_id'], unique=False)
    
    # Create user_case_permissions_orm table (duplicate for ORM compatibility)
    op.create_table('user_case_permissions_orm',
        sa.Column('id', sa.String(length=36), nullable=False),
        sa.Column('user_id', sa.String(length=36), nullable=False),
        sa.Column('case_id', sa.String(length=36), nullable=False),
        sa.Column('permission_level', sa.Enum('read', 'write', 'admin', name='permissionlevel'), nullable=False),
    ...
    op.create_index('idx_user_case_perm_case_id', 'user_case_permissions_orm', ['case_id'], unique=False)
    op.create_index('idx_user_case_perm_user_case', 'user_case_permissions_orm', ['user_id', 'case_id'], unique=True)
    op.create_index('idx_user_case_perm_user_id', 'user_case_permissions_orm', ['user_id'], unique=False)
