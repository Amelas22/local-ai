...
async def refresh_token(
    ...
    refresh_token_obj = await AuthService.validate_refresh_token(db, token_request.refresh_token)
...
async def change_password(
    ...
    # Update password
    success = await UserService.update_password(db, current_user.id, password_data.new_password)
