...
from src.api.agent_endpoints import router, AnalyzeRequest, SearchRequest, CategorizeRequest
...
class TestAgentEndpoints:
    ...
    def test_analyze_endpoint_success(self, client, mock_case_context, auth_headers):
        ...
        with patch('src.api.agent_endpoints.require_case_context') as mock_auth:
            ...
            with patch('src.ai_agents.bmad_framework.AgentLoader') as mock_loader:
                ...
                mock_loader.return_value.load_agent = AsyncMock(return_value=mock_agent_def)
                
                with patch('src.ai_agents.bmad_framework.AgentExecutor') as mock_executor:
    ...
    def test_analyze_endpoint_invalid_request(self, client, mock_case_context, auth_headers):
    ...
    def test_analyze_endpoint_agent_not_found(self, client, mock_case_context, auth_headers):
    ...
    def test_search_endpoint_case_mismatch(self, client, mock_case_context, auth_headers):
    ...
    def test_websocket_event_emission(self, client, mock_case_context, auth_headers):
        ...
        with patch('src.api.agent_endpoints.require_case_context') as mock_auth:
            ...
            with patch('src.ai_agents.bmad_framework.AgentLoader') as mock_loader:
                ...
                with patch('src.ai_agents.bmad_framework.websocket_progress.track_progress') as mock_tracker:
