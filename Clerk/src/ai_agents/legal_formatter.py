...
class LegalFormatter:
    ...
    def format_certificate_of_service(
        ...
        cert += f"a true and correct copy of the foregoing was served by {service_method} "
    ...
    def format_wherefore_clause(
        ...
        if include_costs:
            wherefore += f"{next_num}. Award {party_name} costs and attorney's fees;\n\n"
            next_num += 1
