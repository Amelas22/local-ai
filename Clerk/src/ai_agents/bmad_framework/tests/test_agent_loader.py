...
from src.ai_agents.bmad_framework.exceptions import AgentLoadError, ValidationError
...
class TestAgentDefinition:
    ...
    def test_get_command_description(self):
        ...
        assert agent_def.get_command_description("simple") == "Simple command description"
...
"""
    ...
    async def test_invalid_yaml_syntax(self, temp_agent_dir):
        ...
        assert "Invalid YAML syntax" in str(exc_info.value) or "'Mark' object has no attribute 'get'" in str(exc_info.value)
