...
class APIIntegrationTests:
    ...
    async def test_analyze_endpoint_integration(self):
        ...
        async with await self.get_client() as client:
            ...
            logger.info(
                f"Analyze endpoint returned processing_id: {data['processing_id']}"
            )
            return data
    ...
    async def test_search_endpoint_integration(self):
        ...
        async with await self.get_client() as client:
            ...
            test_queries = [
                {
                    ...
                    "filters": {"document_types": ["discovery", "production"]},
                },
                {
                ...
                {"query": "financial statements quarterly reports", "filters": {}},
            ]
            ...
            logger.info(
                f"Search endpoint tests completed for {len(test_queries)} queries"
            )
    ...
    async def test_categorize_endpoint_integration(self):
        ...
        async with await self.get_client() as client:
            ...
            logger.info(
                f"Categorization endpoint tests completed for {len(test_scenarios)} scenarios"
            )
            ...
            for format_type in formats:
                try:
                    response = await client.get(
                        ...
                        params={"format": format_type, "include_evidence": True},
                        headers=self.headers,
                    )
                    ...
                    report_results.append({"format": format_type, "error": str(e)})
        ...
        async with await self.get_client() as client:
            ...
            for i in range(20):  # Test with 20 rapid requests
                ...
                if response.status_code == status.HTTP_429_TOO_MANY_REQUESTS:
                    rate_limit_results["search_endpoint"]["rate_limited_at"] = (
                        request_count
                    )
                    rate_limit_results["search_endpoint"]["retry_after"] = (
            ...
            logger.info(
                f"Rate limiting test completed: {request_count} requests in {elapsed_time:.2f}s"
            )
    ...
    async def test_error_handling_integration(self):
        ...
        async with await self.get_client() as client:
            ...
            logger.info(
                f"Error handling tests completed for {len(error_scenarios)} scenarios"
            )
