...
from src.ai_agents.bmad_framework.websocket_progress import ProgressTracker
...
class ComponentIntegrationTests:
    ...
    async def test_vector_search_integration(self):
        ...
        for query in test_queries:
            ...
            search_results[query] = {
                ...
                "documents": [
                    r.metadata.get("document_name", "unknown")
                    for r in results
                ]
            }
    ...
    async def test_websocket_progress_integration(self):
        ...
        logger.info(f"WebSocket progress tracking test completed with {len(events_emitted)} events")
    ...
    async def test_template_rendering(self):
        ...
        template_path = Path("/app/src/ai_agents/bmad_framework/templates/deficiency-report-tmpl.yaml")
