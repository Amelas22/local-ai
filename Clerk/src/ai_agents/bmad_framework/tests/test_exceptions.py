...
class TestAPIMappingError:
    ...
    def test_api_mapping_error_with_suggestions(self):
        ...
        details = {"available_commands": ["*help", "*search"], "closest_match": "*search"}
...
class TestDependencyNotFoundError:
    ...
    def test_template_dependency_not_found_with_message(self):
        ...
        assert "Template dependency 'legal-doc-tmpl.yaml' not found: Check templates directory" in str(error)
...
class TestValidationError:
    ...
    def test_agent_definition_validation_error(self):
        ...
        error = ValidationError("Agent definition", "Multiple validation failures", details)
