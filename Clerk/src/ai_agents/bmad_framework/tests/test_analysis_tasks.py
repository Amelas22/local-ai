...
class TestAnalysisTasks:
    ...
    async def test_analyze_rtp_task_success(
        self, task_executor, mock_case_context, mock_rtp_parser
    ):
    ...
    async def test_analyze_rtp_task_no_requests(
        self, task_executor, mock_case_context, mock_rtp_parser
    ):
    ...
    async def test_search_production_task_success(
        self, task_executor, mock_case_context, mock_qdrant_store
    ):
        ...
        mock_qdrant_store.hybrid_search.return_value = [
            {
                ...
                "metadata": {"page_number": 5, "document_name": "Contract_2022.pdf"},
            },
            {
                "document_id": "doc-2",
                "chunk_text": "The agreement states...",
                "relevance_score": 0.85,
                "metadata": {"page_number": 12, "document_name": "Agreement_2022.pdf"},
            },
        ]
    ...
    async def test_search_production_with_filters(
        self, task_executor, mock_case_context, mock_qdrant_store
    ):
        ...
        mock_qdrant_store.hybrid_search.return_value = [
            {
                ...
                "metadata": {"document_type": "email", "date": "2022-03-15"},
            }
        ]
    ...
    async def test_categorize_compliance_task_fully_produced(
        self, task_executor, mock_case_context
    ):
    ...
    async def test_categorize_compliance_task_partially_produced(
        self, task_executor, mock_case_context
    ):
    ...
    async def test_categorize_compliance_task_not_produced(
        self, task_executor, mock_case_context
    ):
    ...
    async def test_categorize_compliance_task_no_responsive_docs(
        self, task_executor, mock_case_context
    ):
    ...
    async def test_generate_evidence_chunks_task(
        self, task_executor, mock_case_context
    ):
    ...
    async def test_task_execution_with_websocket_progress(
        self, task_executor, mock_case_context
    ):
