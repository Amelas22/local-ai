...
class AgentLoadError(BMadFrameworkError):
    ...
    def __init__(
        self, agent_id: str, message: str, details: Optional[Dict[str, Any]] = None
    ):
        """
...
class TaskExecutionError(BMadFrameworkError):
    ...
    def __init__(
        self, task_name: str, message: str, details: Optional[Dict[str, Any]] = None
    ):
        """
...
class APIMappingError(BMadFrameworkError):
    ...
    def __init__(
        self, command: str, message: str, details: Optional[Dict[str, Any]] = None
    ):
        """
        ...
        """
        super().__init__(
            f"API mapping for command '{command}' failed: {message}", details
        )
...
class DependencyNotFoundError(BMadFrameworkError):
    ...
    def __init__(
        ...
        """
        error_msg = (
            f"{dependency_type.capitalize()} dependency '{dependency_name}' not found"
        )
        if message:
            error_msg += f": {message}"
