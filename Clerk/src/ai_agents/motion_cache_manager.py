...
class ContextCache:
    ...
    async def store_section_context(self, 
                                  motion_id: str,
                                  section_id: str,
    ...
    async def get_section_context(self, 
                                motion_id: str, 
                                section_id: str) -> Optional[Dict[str, Any]]:
        """Get context for a specific section"""
        async with self._lock:
            motion_context = self.context_cache.get(motion_id, {})
            return motion_context.get(section_id)
    
    async def build_cumulative_context(self, 
                                     motion_id: str,
                                     up_to_section: str) -> Dict[str, Any]:
